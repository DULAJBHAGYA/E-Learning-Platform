...
const Color darkblue = Color(0xFF335ef7);
const Color blue = Color(0xFF5176f9);
const Color lightblue = Color(0xFF819bf9);
const Color black = Color(0xFF000000);
const Color grey = Color(0xFF5D5A5A);
const Color lightgrey = Color(0xFF7C7A7A);
...
const Color science = Color(0xFF27c5a5); //sicence
const Color maths = Color(0xFFfbd330); //math
