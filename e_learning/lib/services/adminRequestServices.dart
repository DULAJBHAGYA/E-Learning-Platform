...
class AdminRequestsService {
  ...
  static final AdminRequestsService _instance =
      AdminRequestsService._internal();
  ...
  static AdminRequestsService get instance => _instance;

  Future<dynamic> fetchAllAdminRequests(int user_id,
      ) async {
    try {
      ...
      final response =
          await _dio.get('/api/v3/list/request/byuser?user_id=$user_id');
