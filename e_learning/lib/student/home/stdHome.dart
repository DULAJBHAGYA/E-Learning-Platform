                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('Registered \nCourses', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600, color: white),),
                      ],
                    ),    
                  )
                )  ,
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text('Data Science \Advanced', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.bold, color: black),),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Text('All 🔥', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600, color: darkblue),),
                  ),
